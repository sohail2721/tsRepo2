...
```bash
npm install petstore-pkg@1.0.0
```

For additional package details, see the [Npm page for the petstore-pkg@1.0.0 npm](https://www.npmjs.com/package/petstore-pkg/v/1.0.0).
